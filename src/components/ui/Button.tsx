...
export default function Button(props: ButtonProps) {
  ...
  const variantStyles = {
    ...
    home: 'bg-home-elements/80 text-black/70 px-10 sm:px-12 md:px-16 py-2 md:py-2 rounded-full text-2xl md:text-2xl font-sans uppercase whitespace-nowrap insert-shadow-sm shadow-xl hover:bg-home-elements/90 hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out',
    secondary:
